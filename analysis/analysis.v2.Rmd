...
Notes:
  ...
  1) the geographic figures are not standardised
  2) we print the percentage of double dippers as a proportion of the total # of benzo users alone, # of opioid users alone, the percentage of users who use opioids and benzo, at seperate times, and finally, as a proportion of the total population
