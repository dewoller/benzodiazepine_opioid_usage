...
df_patient %>%
  ...
  mutate( 
         pct_benzo = round( `2_double-dipper`*10 / `1_benzodiazapine`, 5),
         pct_opioid = round( `2_double-dipper`*10 / `1_opioid`, 5),
         `pct_seperate-times` = round( `2_double-dipper`*10 / `2_seperate_times`, 5),
         pct_pop = round( `2_double-dipper`*10 / population, 5)
         ) %>%
  kable()
